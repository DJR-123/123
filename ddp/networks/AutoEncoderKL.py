    ...
    def __init__(
        ...
        for i, up_block_type in enumerate(up_block_types):
            ...
            fuse_layer = Fuse_sft_block_RRDB(
                in_ch=prev_output_channel,
                out_ch=prev_output_channel,
...
class OursAutoencoderKL(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    def _decode(
        self, z: torch.Tensor, enc_fea_hdr, return_dict: bool = True
    ...
    @apply_forward_hook
    def decode(
        self, z: torch.Tensor, enc_fea_hdr, return_dict: bool = True, generator=None
    ) -> Union[DecoderOutput, torch.Tensor]:
        """
