...
class evsImageH5SingleDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        # --- 修改点 1 ---
        # 访问 H5 文件中名为 'train' 的组 (group)
        self.train_group = self.File["home"]["datasets"]["HDR-EVS-Dataset"]["train1"]

        # --- 修改点 2 ---
        # 从 'train' 组中获取所有样本的键 (key)，这会修复 "Num examples = 1" 的问题
        self.files = list(self.train_group.keys())
    ...
    def __getitem__(self, index):
        ...
        # --- 修改点 3 ---
        # 从 self.train_group (而不是 self.File) 中访问样本
        File = self.train_group[video_name]
