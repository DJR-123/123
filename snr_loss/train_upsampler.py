...
from networks import HDRev_Encoder_Hybrid, OursAutoencoderKL
...
def main(name, config, use_wandb=False, debug=False, pretrained=("", "")):
    ...
    print("Using Hybrid encoder (ConvLSTM + Swin) for upsampler training")
    ...
    if pretrained_unet != "":
        ...
        raise ValueError("pretrained_unet is required for upsampler training")
